...
namespace ServiceRest_20190140011_Bima_Bayu_Saputra
{
	...
	public class TI_UMY : ITI_UMY
	{
		...
		{
			string msg = "GAGAL";
			SqlConnection sqlcon = new SqlConnection("Data Source=DESKTOP-TBC7MDB;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa; Password=k1R3aw5G ");
		...
		public List<Mahasiswa> GetAllMahasiswa()
		{
			...
			SqlConnection con = new SqlConnection("Data Source=DESKTOP-TBC7MDB;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa; Password=k1R3aw5G ");
